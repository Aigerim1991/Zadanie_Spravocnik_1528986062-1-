...
reference_book reference_book::Add(string name_of_company, string owner, long long telephone_number, string adress, string hobby)
{
	ofstream fout("Reference book.txt");

	fout << "========== Reference book ========== " << endl;
	fout << "Name of company: " << name_of_company << endl;
	fout << "Owner: " << owner << endl;
	fout << "Telephone number: " << telephone_number << endl;
	fout << "Adress: " << adress << endl;
	fout << "Hobby: " << hobby << endl;
	fout << "===== ===== ===== ===== ===== ===== " << endl;
